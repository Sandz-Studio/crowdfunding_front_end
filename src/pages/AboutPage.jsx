    ...
    return (
        <div className="container">
            ...
            <ol>
                ...
                <li>Parents and Families: Families of young soccer enthusiasts seeking assistance with the costs associated with their children's soccer participation, encompassing registration fees and equipment.</li>
                <li>Community Members: Local residents eager to support and bolster grassroots sports, particularly soccer, within their vicinity.</li>
                <li>Sponsors and Donors: Prospective sponsors and donors driven by a passion for nurturing youth sports and interested in contributing to specific campaigns or initiatives on the platform.</li>
